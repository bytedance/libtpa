...
STATS(ARP_RECV_REQUEST,  "number of ARP request received")
STATS(ARP_RECV_REPLY,    "number of ARP reqply received")
STATS(WARN_ARP_INVALID_OP,  "ARP opcode is invalid")
STATS(WARN_ARP_INVALID_LEN, "ARP haredhare or protocol len is invalid")
